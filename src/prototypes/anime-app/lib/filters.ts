 ...
 * "extension" source displays correctly.
 */
...
/** Determine the current AniList season (WINTER/SPRING/SUMMER/FALL) + year.
 *  December rolls into WINTER of the next year (matches original script). */
export function currentSeason(): { season: string; year: number } {
  ...
  // December (m === 11) → WINTER of next year.
